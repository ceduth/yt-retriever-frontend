...
/**
 * FetchedResultsPage 
 * Renders the page for scraping YouTube video statistics.
 * It allows users to input video IDs or URLs, scrape the data, and download the results as a CSV file.
 */
